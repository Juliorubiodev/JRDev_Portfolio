          ...
          {t.experience.jobs.map((job, index) => (
            ...
            >
              ...
              >
                <motion.div
                  whileHover={{ y: -4 }}
                  className="p-6 rounded-xl bg-card border border-border hover:border-primary/40 transition-all duration-200 hover:shadow-lg hover:shadow-primary/5"
                >
                  <span className="inline-block px-3 py-1 text-xs font-medium font-mono rounded-full bg-primary/10 text-primary mb-3">
                    {job.period}
                  </span>
                  <h3 className="text-xl font-semibold text-foreground mb-1 font-heading">
                    {job.title}
                  </h3>
